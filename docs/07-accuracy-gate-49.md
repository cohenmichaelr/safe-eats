...
| | |
| --- | --- |
| Seed | `safe-eats/AC-E2-GATE/county-49/2026-09-03` |
| Population | 3 geocoded of 3 displayed Liberty establishments |
| Population filter | county 49 Liberty · licence type 2010 (DEC-009) · geocoded |
| Population fingerprint | `bcc301488c2fb94c` |
| Census size | 3 — every displayed establishment in the county (DEC-017) |
| Drawn at | 2026-09-03T23:12:35Z |
...
Establishments without coordinates (0 of 3) are excluded:
...
aerial imagery. For each of the 3 rows in the worksheet:
